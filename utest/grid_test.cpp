...
// TEST_F(BlockTest, TestSmall) {
//   int const step_count = 5;
//   auto const read_ppm  = static_cast<float>(small.parameters.ppm);
//   auto const read_np   = static_cast<int>(small.parameters.np);
...
//   int const step_count = 5;
//   auto const read_ppm  = static_cast<float>(large.parameters.ppm);
//   auto const read_np   = static_cast<int>(large.parameters.np);
//   for (int i = 0; i < step_count; ++i) {
//     large.processStep();
